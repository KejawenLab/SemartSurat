 ...
 */
class MonthNumberFormat implements NumberFormatInterface
{
    private const FORMAT = 'MONTH';
    private const FORMAT_LONG = 'MONTH_LONG';
    private const FORMAT_ROMAN = 'MONTH_ROMAN';
    ...
    public function getNumber(string $format): string
    {
        ...
        if ($format->equals(static::FORMAT_ROMAN)) {
            return RomanNumberConverter::convert((int) date('n'));
        }

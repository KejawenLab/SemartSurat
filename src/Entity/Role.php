 ...
 * @ORM\Entity(repositoryClass="KejawenLab\Semart\Surat\Repository\RoleRepository")
 *
...
class Role
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="KejawenLab\Semart\Surat\Entity\Group", fetch="EAGER", cascade={"persist"})
    ...
    /**
     * @ORM\ManyToOne(targetEntity="KejawenLab\Semart\Surat\Entity\Menu", fetch="EAGER", cascade={"persist"})
